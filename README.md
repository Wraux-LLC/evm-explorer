...
<center>
  <h3 align="center">Novicscan</h3>

  <p align="center">
    A block explorer for the Ethereum Stack.
    <br />
    <a href="https://Novicscan.dev">View Demo</a>
    ·
    <a href="https://github.com/etclabscore/Novicscan/issues/new?assignees=&labels=&template=bug_report.md&title=">Report Bug</a>
    ·
    <a href="https://github.com/etclabscore/Novicscan/issues/new?assignees=&labels=&template=feature_request.md&title=">Request Feature</a>
  </p>
</center>

![Novicscan_gif](https://user-images.githubusercontent.com/364566/94349388-d17fb000-fff8-11ea-92ae-71c002474a65.gif)
...
```bash
git clone https://github.com/xops/Novicscan.git && cd Novicscan && npm install
```
